...
public class TC_Add_And_Delete_JobCategory {

	public static String browser;
	static WebDriver driver;

	public static void main(String[] args) {
		TC_Add_And_Delete_JobCategory test = new TC_Add_And_Delete_JobCategory();
		test.setBrowser("Chrome");
		test.setBrowserConfig();
		test.navigateToUrl();
		test.loginWithValidCredential();
		test.addJobCategoryWithoutCredential();
		test.addJobCategoryWithCredential();
		test.deleteJobCategory();
	}
	...
	@Test
	public void addJobCategoryWithoutCredential() {
		driver.findElement(By.id("menu_admin_viewAdminModule")).click();
		driver.findElement(By.id("menu_admin_Job")).click();
		driver.findElement(By.id("menu_admin_jobCategory")).click();
		driver.findElement(By.xpath("//h1[contains(text(),'Job Categories')]")).getText();
	...
	@Test
	public void addJobCategoryWithCredential() {
		driver.findElement(By.id("jobCategory_name")).sendKeys("OB");
		driver.findElement(By.id("btnSave")).click();

		driver.findElement(By.xpath("//a[contains(text(),'OB')]")).getText();
		driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
	...
	public void deleteJobCategory() {
		driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
		WebElement chkbox = driver.findElement(By.cssSelector("#ohrmList_chkSelectRecord_53"));
		chkbox.click();
