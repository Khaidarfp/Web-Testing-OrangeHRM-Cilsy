...
public class TC_Add_And_Delete_Languages {

	public static String browser;
	static WebDriver driver;

	public static void main(String[] args) {
		TC_Add_And_Delete_Languages test = new TC_Add_And_Delete_Languages();
		test.setBrowser("Chrome");
		test.setBrowserConfig();
		test.navigateToUrl();
		test.loginWithValidCredential();
		test.addLanguagesWithoutCredential();
		test.addLanguagesWithCredential();
	...
	@Test
	public void addLanguagesWithoutCredential() {
		driver.findElement(By.id("menu_admin_viewAdminModule")).click();
		driver.findElement(By.id("menu_admin_Qualifications")).click();
		driver.findElement(By.id("menu_admin_viewLanguages")).click();
		driver.findElement(By.xpath("//h1[contains(text(),'Languages')]")).getText();
	...
	@Test
	public void addLanguagesWithCredential() {
		driver.findElement(By.id("language_name")).sendKeys("1batak");
		driver.findElement(By.id("btnSave")).click();
		
		driver.findElement(By.xpath("//a[contains(text(),'1batak')]")).getText();
		driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
