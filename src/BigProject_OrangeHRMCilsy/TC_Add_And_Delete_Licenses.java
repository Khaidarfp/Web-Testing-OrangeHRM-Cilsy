...
public class TC_Add_And_Delete_Licenses {

	public static String browser;
	static WebDriver driver;

	public static void main(String[] args) {
		TC_Add_And_Delete_Licenses test = new TC_Add_And_Delete_Licenses();
		test.setBrowser("Chrome");
		test.setBrowserConfig();
		test.navigateToUrl();
		test.loginWithValidCredential();
		test.addLicensesWithoutCredential();
		test.addLicensesWithCredential();
		test.deleteLicenses();
	}
	...
	@Test
	public void addLicensesWithoutCredential() {
		driver.findElement(By.id("menu_admin_viewAdminModule")).click();
		driver.findElement(By.id("menu_admin_Qualifications")).click();
		driver.findElement(By.id("menu_admin_viewLicenses")).click();
		driver.findElement(By.xpath("//h1[contains(text(),'Licenses')]")).getText();
	...
	@Test
	public void addLicensesWithCredential() {
		driver.findElement(By.id("license_name")).sendKeys("1testing");
		driver.findElement(By.id("btnSave")).click();
