...
public class TC_Add_And_Delete_Skill {

	public static String browser;
	static WebDriver driver;

	public static void main(String[] args) {
		TC_Add_And_Delete_Skill test = new TC_Add_And_Delete_Skill();
		test.setBrowser("Chrome");
		test.setBrowserConfig();
		test.navigateToUrl();
		test.loginWithValidCredential();
		test.addSkillWithoutCredential();
		test.addSkillWithCredential();
		test.deleteSkill();
	}
	...
	@Test
	public void addSkillWithoutCredential() {
		driver.findElement(By.id("menu_admin_viewAdminModule")).click();
		driver.findElement(By.id("menu_admin_Qualifications")).click();
		driver.findElement(By.id("menu_admin_viewSkills")).click();
		driver.findElement(By.xpath("//h1[contains(text(),'Skills')]")).getText();
	...
	@Test
	public void addSkillWithCredential() {
		driver.findElement(By.id("skill_name")).sendKeys("1testing");
		driver.findElement(By.id("skill_description")).sendKeys("test");
		driver.findElement(By.id("btnSave")).click();
		
		driver.findElement(By.xpath("//a[contains(text(),'1testing')]")).getText();
		driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
